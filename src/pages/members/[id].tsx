...
const MEMBERS_DATA: Record<string, MemberData> = {
  '1': {
    ...
    totalMeetings: 50,
    projects: [
      { name: 'SNF Platform', role: 'Lead Developer', status: 'Active' },
  ...
  '2': {
    ...
    totalMeetings: 40,
    projects: [
      { name: 'SNF Platform', role: 'Product Manager', status: 'Active' },
  ...
  '3': {
    ...
    totalMeetings: 35,
    projects: [
      { name: 'SNF Platform', role: 'UX Designer', status: 'Active' },
