    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 sm:px-6 py-4 sm:py-8 space-y-6">
        ...
        <div className="grid grid-cols-1 gap-6">
            ...
            <Card className="overflow-hidden flex flex-col">
              ...
              <CardContent className="px-2 sm:px-6">
                {expiringSubscriptions.length === 0 ? (
                  ...
                  <div className="rounded-md border overflow-auto max-h-[600px] table-container">
                    <Table>
                      <TableHeader>
                        <TableRow>
          ...
          {type !== 'snf' && (
            <Card className="overflow-hidden flex flex-col border-l-4 border-l-destructive">
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-destructive">
                  <CreditCard className="h-5 w-5" />
                  Expired Subscriptions
                </CardTitle>
                <CardDescription>Subscriptions that have already reached their end date</CardDescription>
              </CardHeader>
              <CardContent className="px-2 sm:px-6">
                {expiredSubscriptions.length === 0 ? (
                  ...
                  <div className="rounded-md border overflow-auto max-h-[600px] table-container">
                    <Table>
                      ...
                      <TableBody>
                        {expiredSubscriptions.map((sub: ExpiringSubscription) => (
                          <TableRow key={sub.id} className="bg-destructive/5">
                            <TableCell className="font-medium text-sm">{sub.memberName}</TableCell>
                            <TableCell className="text-sm">{sub.productName}</TableCell>
                            <TableCell className="text-sm">{new Date(sub.expiryDate).toLocaleDateString('en-IN')}</TableCell>
                            <TableCell className="text-center">
