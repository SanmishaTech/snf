...
export default function CommandPalette() {
  ...
  const links = useMemo<CommandLink[]>(
    () => [
      ...
      { group: "Indraai Reports", title: "Purchase Order Report", href: "/admin/reports/purchase-orders" },
      { group: "Indraai Reports", title: "Delivery Agency Report", href: "/admin/reports/delivery-agencies" },
      { group: "Indraai Reports", title: "Delivery Summaries", href: "/admin/reports/delivery-summaries" },
      { group: "Indraai Reports", title: "Subscription Reports", href: "/admin/reports/subscriptions" },
      { group: "Indraai Reports", title: "Sale Register", href: "/admin/reports/sale-register" },
      { group: "Indraai Reports", title: "Revenue Report", href: "/admin/reports/revenue" },
      { group: "Indraai Reports", title: "Wallet Report", href: "/admin/reports/wallet" },
      { group: "Indraai Reports", title: "Exception Report", href: "/admin/reports/exceptions" },
