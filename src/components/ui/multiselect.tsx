  ...
  (
    ...
    return (
      <Command
        ...
        className={cn(
          "h-auto overflow-visible bg-transparent min-w-full",
      ...
      >
        <div
          className={cn(
            "relative min-h-[38px] min-w-full rounded-lg border border-input text-sm transition-shadow focus-within:border-ring focus-within:outline-none focus-within:ring-[3px] focus-within:ring-ring/20 has-[:disabled]:cursor-not-allowed has-[:disabled]:opacity-50",
            {
